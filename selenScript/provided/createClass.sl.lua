local __sls_addressCache=setmetatable({},{__mode="k"})
local function getTblAddr(tbl)local mt=getmetatable(tbl)
...
local function __sls_createClass(clsName)local cls={__sls_clsName=clsName,__sls_inherits={}}
...
else return "<Object of "..(tostring(cls)..(" at "..(getTblAddr(self)..">")))
end
end
