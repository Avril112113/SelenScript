...
---@param args {_parent:SelenScript.ASTNodes.Node?, start:SelenScript.ASTNodes.SrcPosition?, finish:SelenScript.ASTNodes.SrcPosition?, [integer]:string|SelenScript.ASTNodes.Node}
---@return SelenScript.ASTNodes.Node
ASTNodesSpecial["OutputRaw"] = function(args)
	args["source"] = args._parent and args._parent.source or nil
	args["type"] = "Special_OutputRaw"
